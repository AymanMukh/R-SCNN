...
import tensorflow as tf
 ...
 # @params/model-64.txt                                @params/m40-64.txt
# @params/training.txt                                --dset_dir
# /media/SSD/DATA/ayman/papers/spherical-cnn/data/2k/7gz  --logdir tmp/newexp                --run_id m40-so3 argh!
import sys
from os.path import abspath, dirname
sys.path.append(dirname(dirname(abspath(__file__))))
from spherical_cnn import params
from spherical_cnn import models as models #  
